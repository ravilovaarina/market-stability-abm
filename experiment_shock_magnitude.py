...
def main():
    ...
    raw_out = os.path.join(base_dir, "shock_magnitude_raw.csv")
    agg_out = os.path.join(base_dir, "shock_magnitude_agg.csv")
    tipping_out = os.path.join(base_dir, "shock_magnitude_tipping.csv")
    metrics_png = os.path.join(base_dir, "shock_magnitude_metrics.png")
    heatmap_png = os.path.join(base_dir, "shock_magnitude_heatmap.png")
