...
from experiment_h3_volatility_clustering import (
    ALL_METRICS,
    CLUSTERING_METRICS,
    STANDARD_METRICS,
    bootstrap_ci,
...
def output_paths(prefix: str) -> Dict[str, str]:
    return {
        ...
        "interactions": f"{prefix}_interactions.csv",
        "metrics_png": f"{prefix}_metrics.png",
        "heatmap_acf1_png": f"{prefix}_heatmap_acf1.png",
        "heatmap_interaction_png": f"{prefix}_heatmap_interaction.png",
    }
