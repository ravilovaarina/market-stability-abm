...
SOFTLIMIT_BOOTSTRAP = ROOT / "h3_clustering_interactions_bootstrap.csv"
DEPTH_BOOTSTRAP = ROOT / "h3_depth_interactions_bootstrap.csv"
SHOCK_OLS = ROOT / "h3_shock_absorption_ols.csv"
SHOCK_MW = ROOT / "h3_shock_absorption_mw.csv"

OUT_CLUSTERING = ROOT / "h3_final_summary_clustering_interactions.csv"
OUT_SHOCK = ROOT / "h3_final_summary_shock_absorption.csv"
OUT_MD = ROOT / "h3_final_summary.md"
OUT_PNG = ROOT / "h3_final_summary.png"
...
def main() -> None:
    ...
    write_markdown(clustering, shock)
