...
def output_paths(prefix):
    return {
        ...
        "tipping": result_path("h2", "raw", f"{prefix}_tipping.csv"),
        "stats": result_path("h2", "raw", f"{prefix}_stats.csv"),
        "metrics_png": result_path("h2", "figures", f"{prefix}_metrics.png"),
        "heatmap_png": result_path("h2", "figures", f"{prefix}_heatmap.png"),
        "tipping_png": result_path("h2", "figures", f"{prefix}_tipping.png"),
    }
