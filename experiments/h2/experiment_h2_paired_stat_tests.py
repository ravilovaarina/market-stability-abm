...
INPUT_CSV = result_path("h2", "raw", "h2_postshock_volume_paired_diffs.csv")
OUT_CSV = result_path("h2", "raw", "h2_paired_stat_tests.csv")
OUT_PNG = result_path("h2", "figures", "h2_paired_stat_tests.png")
