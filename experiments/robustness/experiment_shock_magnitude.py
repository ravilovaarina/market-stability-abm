...
def main():
    ...
    raw_out = result_path("robustness", "raw", "shock_magnitude_raw.csv")
    agg_out = result_path("robustness", "raw", "shock_magnitude_agg.csv")
    tipping_out = result_path("robustness", "raw", "shock_magnitude_tipping.csv")
    metrics_png = result_path("robustness", "figures", "shock_magnitude_metrics.png")
    heatmap_png = result_path("robustness", "figures", "shock_magnitude_heatmap.png")
