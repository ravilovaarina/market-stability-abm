...
def main():
    ...
    raw_out = RAW_DIR / "shock_magnitude_raw.csv"
    agg_out = TABLE_DIR / "shock_magnitude_agg.csv"
    tipping_out = TABLE_DIR / "shock_magnitude_tipping.csv"
    metrics_png = FIGURE_DIR / "shock_magnitude_metrics.png"
    heatmap_png = FIGURE_DIR / "shock_magnitude_heatmap.png"
