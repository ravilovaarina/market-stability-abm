...
def load_grid3() -> pd.DataFrame:
    path = RAW_DIR / "unified_combined_raw.csv"
    if not path.exists():
...
def main() -> None:
    ...
    tipping_path = TABLE_DIR / "unified_combined_tipping.csv"
    metrics_path = FIGURE_DIR / "unified_combined_metrics.png"
    heatmap_path = FIGURE_DIR / "unified_combined_heatmap.png"
