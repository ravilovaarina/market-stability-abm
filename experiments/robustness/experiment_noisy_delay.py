...
def main():
    ...
    raw_out = ROBUSTNESS_ROOT / "raw" / "noisy_delay_raw.csv"
    agg_out = ROBUSTNESS_ROOT / "tables" / "noisy_delay_agg.csv"
    tipping_out = ROBUSTNESS_ROOT / "tables" / "noisy_delay_tipping.csv"
    metrics_png = ROBUSTNESS_ROOT / "figures" / "noisy_delay_metrics.png"
    heatmap_png = ROBUSTNESS_ROOT / "figures" / "noisy_delay_heatmap.png"
