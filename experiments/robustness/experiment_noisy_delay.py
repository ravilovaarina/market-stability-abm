...
def main():
    ...
    raw_out = result_path("robustness", "raw", "noisy_delay_raw.csv")
    agg_out = result_path("robustness", "raw", "noisy_delay_agg.csv")
    tipping_out = result_path("robustness", "raw", "noisy_delay_tipping.csv")
    metrics_png = result_path("robustness", "figures", "noisy_delay_metrics.png")
    heatmap_png = result_path("robustness", "figures", "noisy_delay_heatmap.png")
