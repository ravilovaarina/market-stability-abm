...
def main():
    ...
    raw_out = RAW_DIR / "noisy_delay_raw.csv"
    agg_out = TABLE_DIR / "noisy_delay_agg.csv"
    tipping_out = TABLE_DIR / "noisy_delay_tipping.csv"
    metrics_png = FIGURE_DIR / "noisy_delay_metrics.png"
    heatmap_png = FIGURE_DIR / "noisy_delay_heatmap.png"
