...
def load_data() -> tuple[pd.DataFrame, pd.DataFrame]:
    speed_path = RAW_DIR / "unified_speed_raw.csv"
    delay_path = RAW_DIR / "unified_delay_raw.csv"
...
def main() -> None:
    ...
    speed_csv = TABLE_DIR / "speed_effect_mannwhitney.csv"
    delay_csv = TABLE_DIR / "delay_effect_mannwhitney.csv"
    speed_png = FIGURE_DIR / "speed_effect_mannwhitney.png"
    delay_png = FIGURE_DIR / "delay_effect_mannwhitney.png"
