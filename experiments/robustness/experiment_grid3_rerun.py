...
def main():
    ...
    raw_out = ROBUSTNESS_ROOT / "raw" / "grid3_rerun_raw.csv"
    skip_out = ROBUSTNESS_ROOT / "raw" / "grid3_rerun_skips.csv"
    agg_out = ROBUSTNESS_ROOT / "tables" / "grid3_rerun_agg.csv"
    plot_out = ROBUSTNESS_ROOT / "figures" / "grid3_rerun.png"
