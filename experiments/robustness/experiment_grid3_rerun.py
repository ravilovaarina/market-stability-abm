...
def main():
    ...
    raw_out = result_path("robustness", "raw", "grid3_rerun_raw.csv")
    skip_out = result_path("robustness", "raw", "grid3_rerun_skips.csv")
    agg_out = result_path("robustness", "raw", "grid3_rerun_agg.csv")
    plot_out = result_path("robustness", "figures", "grid3_rerun.png")
