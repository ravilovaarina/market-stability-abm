...
OUTPUT_ROOT = PROJECT_ROOT / "results" / "h1"
...
def plot_grid_speed(df_raw, agg, save=FIGURE_ROOT / 'unified_speed.png'):
...
def plot_grid_delay(df_raw, agg, save=FIGURE_ROOT / 'unified_delay.png'):
...
def plot_stat_tests(df_raw, save=FIGURE_ROOT / 'unified_stats.png'):
...
if __name__ == '__main__':
    ...
    speed_raw = RAW_ROOT / 'unified_speed_raw.csv'
    delay_raw = RAW_ROOT / 'unified_delay_raw.csv'
    combined_raw = RAW_ROOT / 'unified_combined_raw.csv'
    all_raw = RAW_ROOT / 'unified_all_raw.csv'
