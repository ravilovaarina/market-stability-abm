...
def plot_grid_speed(df_raw, agg, save=None):
    if save is None:
        save = FIGURE_DIR / "unified_speed.png"
...
def plot_grid_delay(df_raw, agg, save=None):
    if save is None:
        save = FIGURE_DIR / "unified_delay.png"
...
def plot_stat_tests(df_raw, save=None):
    if save is None:
        save = FIGURE_DIR / "unified_stats.png"
...
if __name__ == '__main__':
    ...
    speed_raw = RAW_DIR / "unified_speed_raw.csv"
    delay_raw = RAW_DIR / "unified_delay_raw.csv"
    combined_raw = RAW_DIR / "unified_combined_raw.csv"
    all_raw = RAW_DIR / "unified_all_raw.csv"
