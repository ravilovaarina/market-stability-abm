...
plt.tight_layout()
baseline_plot = result_path("h1", "figures", "h1_baseline_check_prices_volatility.png")
plt.savefig(baseline_plot, dpi=150, bbox_inches='tight')
print(f'\nСохранено: {baseline_plot}')
