...
if __name__ == '__main__':
    ...
    plot_price_examples(save=result_path("h1", "figures", "h1_prices.png"))

    print('\n[2/3] Запуск грида (11 × 10 = 110 симуляций)...')
    df = run_grid(n_runs=10, n_iter=500, shock_it=200)
    raw_path = result_path("h1", "raw", "h1_raw.csv")
    ...
    print('\n[3/3] Графики...')
    plot_main(agg, df, save=result_path("h1", "figures", "h1_results.png"))
    print('Готово!')
