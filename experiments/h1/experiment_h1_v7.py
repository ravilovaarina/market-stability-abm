...
if __name__ == '__main__':
    ...
    raw_path = result_path("h1", "raw", "h1_v7_raw.csv")
    ...
    plot_results(
        agg,
        shock_dp=SHOCK_DP,
        save=result_path("h1", "figures", "h1_v7_results.png"),
    )
    plot_heatmap(agg, 'vol_ratio_mean',
                 'Volatility after/before shock: fast_share × lag',
                 save=result_path("h1", "figures", "h1_v7_heatmap_vol.png"))
    plot_heatmap(agg, 'mm_panic_mean',
                 'MM panic: fast_share × lag',
                 save=result_path("h1", "figures", "h1_v7_heatmap_panic.png"))
    print('\nГотово!')
