...
if __name__ == '__main__':
    ...
    sweep_path = result_path("h1", "raw", "h1_sweep.csv")
    df_sweep.to_csv(sweep_path, index=False)
    print(f'Сохранено: {sweep_path}')
    plot_shock_sweep(df_sweep, save=result_path("h1", "figures", "h1_shock_sweep.png"))
    ...
    raw_path = result_path("h1", "raw", f'h1_raw_dp{best_dp}.csv')
    ...
    plot_main(
        ...
        df,
        shock_dp=best_dp,
        save=result_path("h1", "figures", "h1_results_v2.png"),
    )
    print('\nГотово!')
