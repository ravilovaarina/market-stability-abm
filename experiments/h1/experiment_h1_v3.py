...
def plot_results(agg, df, shock_dp, save=None):
    if save is None:
        save = FIGURE_DIR / "h1_v3_results.png"
...
def plot_price_examples(shock_dp=-10, save=None):
    if save is None:
        save = FIGURE_DIR / "h1_v3_price_examples.png"
...
if __name__ == '__main__':
    ...
    df.to_csv(RAW_DIR / "h1_v3_raw.csv", index=False)
