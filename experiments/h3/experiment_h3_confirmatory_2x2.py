...
from experiments.h3.experiment_h3_liquidity_depth import aggregate, run_one
from experiments.h3.experiment_h3_volatility_clustering import bootstrap_ci
...
OUTPUT_ROOT = PROJECT_ROOT / "results" / "h3" / "confirmatory"
...
def output_paths(prefix: str) -> Dict[str, str]:
    return {
        ...
        "cell_interactions": str(OUTPUT_ROOT / "tables" / f"{prefix}_cell_interactions.csv"),
        "run_interactions": str(OUTPUT_ROOT / "tables" / f"{prefix}_run_interactions.csv"),
        "ols": str(OUTPUT_ROOT / "tables" / f"{prefix}_ols_hc3.csv"),
        "metrics_png": str(OUTPUT_ROOT / "figures" / f"{prefix}_metrics.png"),
        "interaction_png": str(OUTPUT_ROOT / "figures" / f"{prefix}_interactions.png"),
    }
