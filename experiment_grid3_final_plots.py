...
def load_grid3(base_dir: str) -> pd.DataFrame:
    path = os.path.join(base_dir, "unified_combined_raw.csv")
...
def main() -> None:
    ...
    df = load_grid3(base_dir)
    tipping = build_tipping_table(df)

    tipping_path = os.path.join(base_dir, "unified_combined_tipping.csv")
    metrics_path = os.path.join(base_dir, "unified_combined_metrics.png")
    heatmap_path = os.path.join(base_dir, "unified_combined_heatmap.png")
