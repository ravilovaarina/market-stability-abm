...
def load_data(base_dir: str) -> tuple[pd.DataFrame, pd.DataFrame]:
    speed_path = os.path.join(base_dir, "unified_speed_raw.csv")
    delay_path = os.path.join(base_dir, "unified_delay_raw.csv")
...
def main() -> None:
    ...
    df_speed, df_delay = load_data(base_dir)

    speed_results = analyze_speed_effect(df_speed)
    delay_results = analyze_delay_effect(df_delay)

    speed_csv = os.path.join(base_dir, "speed_effect_mannwhitney.csv")
    delay_csv = os.path.join(base_dir, "delay_effect_mannwhitney.csv")
    speed_png = os.path.join(base_dir, "speed_effect_mannwhitney.png")
    delay_png = os.path.join(base_dir, "delay_effect_mannwhitney.png")
    report_md = os.path.join(base_dir, "speed_delay_effect_mannwhitney_report.md")
    ...
    write_markdown_report(speed_results, delay_results, report_md)
